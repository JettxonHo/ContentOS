...
1. M2 — Source and Workflow Foundation — is in progress. `M2-WF-003B` is completed through PR #73, merged as `c9c92b70a0ccd99be944107120f03dd3a1776da3`; `M2-WF-003C` is completed through PR #77, merged as `ed428b1c12eb6e2ce01d964d56c05a09a3ba87d1`; `M2-SRC-003` is completed through PR #82, merged as `6b6e4a0f2c180093db6e76090ab14b831e5631f6`; `M2-FETCH-001A` is completed through PR #92, squash-merged as `551217c130f6717f4b8891ce76de1fa124bf8ee0`; `M2-FETCH-001B` is completed through PR #96, squash-merged as `9b28068eb3ed266973f77bcdffe6c08776b2086c`, with private unregistered preparation modules; and `M2-FETCH-001C` is not started. Fetcher execution remains unavailable until the incomplete `M2-FETCH-001` is accepted.
