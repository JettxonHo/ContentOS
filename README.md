...
1. M2 — Source and Workflow Foundation — is in progress. `M2-FETCH-001`, `M2-SRC-004`, `M2-WF-004A`, `M2-WF-004B`, and `M2-WEB-001A` are completed. Source editing, Version/Approval review UI, and M2 acceptance work remain not started.
