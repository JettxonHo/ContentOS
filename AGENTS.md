...
**Current stage:** M1 completed; M2 is in progress (`M2-SRC-001` through `M2-SRC-004`, `M2-WF-001` through `M2-WF-004B`, `M2-FETCH-001A` through `M2-FETCH-001C`, and `M2-WEB-001A` through `M2-WEB-001B` are completed; `M2-FETCH-001` is completed; `M2-QUAL-001` is In Review; `M2-GOV-005` remains not started).
