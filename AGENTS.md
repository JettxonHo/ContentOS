...
**Current stage:** M1 completed; M2 is in progress (`M2-SRC-001`, `M2-SRC-002`, `M2-WF-001`, and `M2-WF-002` completed; `M2-WF-003A` completed through PR #69, merge commit `3211c29ef8e6a934e6473a4f92caf36d8593abc3`; `M2-WF-003B` completed through PR #73, merge commit `c9c92b70a0ccd99be944107120f03dd3a1776da3`; `M2-WF-003C`, `M2-SRC-003`, and `M2-FETCH-001` not started).
