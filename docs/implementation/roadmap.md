...
| `M2-QUAL-008 — Concurrent Cleanup Failure Attribution` | Separate child Harness teardown evidence from parent owned-cleanup verification without changing cleanup behavior. | M2-QUAL-007 blocked by generic cleanup evidence | **Ready.** [Work Packet](work-packets/m2-qual-008-concurrent-cleanup-failure-attribution.md), Issue #163. Definition of Ready passed independent correctness and governance review. Scope is limited to safe ANSI-stripped complete-line child classification, independent allowlisted parent verification classification, deterministic coordinator tests, and harness documentation. It does not change cleanup, timeout, retry, signal, capture, dependencies, product behavior, CI, Acceptance Records, or M3. M2-QUAL-007, M2-QUAL-003, and M2-GOV-006 remain Blocked; M2 remains In Progress and M3 remains Not Started. |
