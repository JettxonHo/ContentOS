...
| `M2-FETCH-001 — Public URL Fetcher`                                      | Execute a Claimed URL-capture Task over the public network under policy and submit a `fetcher-result/v1` result to the API-owned Gateway.                               | `M2-SRC-003` Completed                                     | **Not Started.** Dependency satisfied; a separate Ready Work Item is still required before implementation.                                                                                                                                                                                                                                                                                                                                                                                       |
