...
This Decision supersedes the first-MVP completion portions of DEC-276, DEC-283, DEC-285, DEC-286, and DEC-293. It preserves DEC-269's independent Blog/Xiaohongshu outputs, DEC-270's manual-publishing boundary, DEC-271's human gates, and DEC-272's traceability model.
