...
ContentOS is a personal content-production workspace in which AI assists research, organization, writing, platform packaging, visual planning, and rendering while the user retains editorial authority.
...
The value is not merely generated text. It is a complete content-production process that reduces research, restructuring, platform adaptation, and layout effort while preserving evidence, human control, editing history, and recoverability.
...
→ Xiaohongshu Design and Render
→ Manual Blog and Xiaohongshu Export
```

The formal MVP must finish both output branches. Publishing remains an external, explicit user action.
...
- Rendered Outputs and Export Packages;
...
ContentOS prepares reviewed Export Packages for manual download and publication. It does not connect platform accounts or automatically publish in the MVP. `Exported` and `Published` are distinct states.
...
8. **Visual intent and final rendering remain separate.** Structured Design Specification and registered components drive deterministic output.
...
- **Task Completion:** the user reaches both Approved Export Packages from Sources.
- **Content Trust:** the user can understand Sources, evidence, human contribution, Versions, dependencies, and outdated state.
- **Editing Value:** AI meaningfully reduces research, writing, restructuring, packaging, and layout effort without taking editorial control.
...
| MVP boundary and success | DEC-004, DEC-036, DEC-038–DEC-042, DEC-274–DEC-275, DEC-293–DEC-294 | [Session-008](../sessions/session-008.md), [Session-024](../sessions/session-024.md) |
