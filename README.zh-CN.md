...
1. M2 — 来源与工作流基础 — 正在进行。`M2-FETCH-001`、`M2-SRC-004`、`M2-WF-004A` 与 `M2-WF-004B` 已完成。`M2-WEB-001A` 正在审查：活动 Workspace 已将权威 Source/URL intake REST 读取与既有通知/轮询恢复组合。Source 编辑、Version/Approval 审核 UI 与 M2 acceptance work 均尚未启动。
