...
1. M2 — 来源与工作流基础 — 正在进行。`M2-FETCH-001`、`M2-SRC-004`、`M2-WF-004A` 与 `M2-WF-004B` 已完成。内部的当前已批准 Source 输入投影不提供 Research 就绪判定、Frozen Input、API/UI 或 Research 执行。Source workspace 与 M2 acceptance work 均尚未启动；恢复模块尚未接入 Workspace。
